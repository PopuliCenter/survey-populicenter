...
function Login() {
  ...
  return (
    ...
    >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 p-2 text-gray-500 hover:text-gray-600"
      ...
      <p className="text-center text-2xs text-primary-100 mt-6">© {new Date().getFullYear()} Populi Center</p>
      <AppVersionLabel className="block text-center text-2xs text-primary-200/80 mt-1" />
      <AppFooterLinks className="text-center mt-1.5 text-2xs text-primary-100" linkClassName="underline hover:text-white" />
