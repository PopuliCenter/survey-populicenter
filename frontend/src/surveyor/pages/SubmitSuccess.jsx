      ...
      <div className="bg-white rounded-2xl shadow-md border border-gray-200 max-w-md w-full p-8 text-center">
        ...
        {!offline && (
          questionnaire_number ? (
            <div className="bg-accent-50 border border-accent-200 rounded-xl px-6 py-4 mb-8 inline-block w-full">
              <p className="text-xs text-accent-500 uppercase tracking-wide font-medium mb-1">
                Nomor Kuesioner
              </p>
              <p className="text-2xl font-bold text-accent-700 tracking-wider">
                {questionnaire_number}
              </p>
            </div>
          ) : (
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full bg-accent-600 hover:bg-accent-700 text-white font-semibold py-3 px-6 rounded-xl transition-colors"
          >
