 ...
 *   - Tombol angka 5 memiliki class bg-blue-600 ketika nilai terpilih adalah 5
...
describe('RatingScaleField — mode numbers', () => {
  ...
  test('tombol angka 5 memiliki class bg-blue-600 ketika nilai terpilih adalah 5', async () => {
    api.get.mockResolvedValue({
      data: buildSurveyWithRating({ options: { min: 1, max: 10, display: 'numbers', labels: {} } }),
    });
    ...
    await waitFor(() => {
      ...
      expect(btn5Updated.className).toContain('bg-blue-600');
    });
  });
});
